        ...
        <div className="page">
          <section>
            ...
            <div className="sub-section text-body projects">
              ...
              <p>
                <br />
                The NYC Building monitor is a tool that NYC tenants can use to help them make
                informed housing decisions and fight for housing justice. This ongoing project is a
                daily updated resource of public city data on building violations, building-related
                311 calls, and a wealth of other city information visualized and made accessible
                through a user-friendly map and interface.
              </p>
              <br />
              ...
              <p>
                <br />A data project using D3.js that visualizes and categorizes the targets of
              ...
              <p>
                <br />A Node scraper for supplying Twitter data to Trump Tweets. Collects the latest
                data from{' '}
                <a
              ...
              <p>
                ...
                . Queries the census database, extracts data, and formats population demographic
              ...
              <p>
                <br />A static website built in collaboration with an artist/activist for the
                promotion of a the right to remove your information from search results in the
                United States and to fight the abuse of personal information on the internet.
              </p>
              <br />
              ...
              <p>
                <br />A medical data logging and education site architectured, built, and hosted to
                comply with HIPPA privacy and security regulations. Rails framework + Linux server.
              </p>
              <br />
              ...
              <p>
                <br />A spear-ph*shing site set up for educational purposes for a friend's podcast
                discussion. Mimics appearance of yahoo.com's login site which was tweaked to deliver
                the user's password to an email address.
              </p>
            </div>
          </section>
        </div>
