        ...
        <div className="page">
          <section>
            ...
            <div className="sub-section text-body">
              <p>
                I'm a web developer and technology consultant based in Brooklyn, NY. Some things I like are an
                internet that respects all people, open and consensual communities, data activism, comics, video
                games, music, and rock climbing.
              </p>
              <br/>
              <p>
                I currently work as an independent web developer and tech consultant. I enjoy doing projects that
                align with my values for a more egalitarian and tolerant world, teaching people about technology and
                coding, and helping people with their independent projects. Before this, I was a software engineer
                at{' '}
            ...
            <div className="sub-section text-body projects">
              ...
              <p>
                <br/>The NYC Building monitor is a tool that NYC tenants can use to help them make informed housing
                  decisions and fight for housing justice. This ongoing project is a daily updated resource of public
                  city data on building violations, building-related 311 calls, and a wealth of other city information
                  visualized and made accessible through a user-friendly map and interface.
              </p>
              <br/>
              ...
              <p>
                <br/>A data project using D3.js that visualizes and categorizes the targets of Donald Trump's
                  twitter insults.
              </p>
              <br/>
              ...
              <p>
                <br/>A static website built in collaboration with an artist/activist for the promotion of a the
                  right to remove your information from search results in the United States and to fight the abuse of
