        ...
        <div className ='page'>
          <section>
            ...
            <div className='sub-section text-body'>
              <p>My name is Jeff. I'm based in Brooklyn, NY. I like information security, an internet that respects all people, cultural diversity, open and consensual communities, art, games, and music.</p>
              <br />
